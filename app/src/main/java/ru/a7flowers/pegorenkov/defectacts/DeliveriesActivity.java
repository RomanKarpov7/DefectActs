...
public class DeliveriesActivity extends ItemActivity implements DeliveryAdapter.TakePhotoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model = ViewModelProviders.of(this, ViewModelFactory.getInstance(getApplication(), getSupportFragmentManager())).get(DeliveriesViewModel.class);
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                model.refreshData(getSupportFragmentManager());
            }
        });
